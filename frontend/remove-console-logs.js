...
// Function to process all TypeScript/React files in a directory
...
// Main execution
console.log('🧹 Removing console.log statements from frontend components...');
console.log('============================================================');

const frontendSrcPath = path.join(__dirname, 'src');
const cleanedCount = processDirectory(frontendSrcPath);
